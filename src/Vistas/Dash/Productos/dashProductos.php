    ...
    <div class="main d-flex flex-column justify-content-start align-items-start w-100" >
        ...
        <div class="content">
            <div class="d-flex justify-content-between align-items-center flex-row" style="margin-bottom: 40px">
                ...
                <button class="btn btn-primary" style="width: 150px!important; height: 35px!important;padding:0!important;" id="btnSwitch">Agregar</button>
            </div>
                ...
                <div class="main-table">
                    <table class="table">
                        ...
                        <tbody id="tableProductos">
                            <tr>
                                <td>
                                    <span>Cobertura de chocolate 75%</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <span>600<span> Unidades</span></span>
                                </td>
                                <td>
                                    <span>20/10/2024</span>
                                    <div class="tooltipS">20 de Octubre de 2024</div>
                                </td>
                                <td>
                                    <button class="btn btn-primary">Editar</button>
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#desactivarProductoModal">Desactivar</button>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>20/10/2024</span>
                                    <div class="tooltipS">20 de Octubre de 2025</div>
                                </td>
                                <td>
                                    <button class="btn btn-primary">Editar</button>
                                    <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#desactivarProductoModal">Desactivar</button>
